...
void Slave_GPIO_InterruptPinInit(void)
{
	...
	spiIntPin.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_INT_FALL;
	spiIntPin.GPIO_PinConfig.GPIO_PinSpeed = GPIO_OUT_SPEED_LOW;
...
int main(void)
{
	...
	*/
	...
	while(1){
		...
		GPIO_IRQInterruptConfig(IRQ_EXTI9_5,DISABLE);
